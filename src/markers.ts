...
export const sampleMarkers: Marker[] = [
  { id:'cd4', name:'CD4', canonicalName:'CD4', status:'Positive', palette:'blue', cellularLocation:'surface', visualFamily:'membrane-receptor', resultState:'present', orientation:-20, x:34, y:24, labelX:19, labelY:16,
  ...
  { id:'cd30', name:'CD30', canonicalName:'CD30', status:'Present', palette:'coral', cellularLocation:'surface', visualFamily:'branched-receptor', visualVariant:'three-tip', resultState:'present', size:1.2, orientation:16, x:71, y:25, labelX:83, labelY:16,
  ...
  { id:'cd7', name:'CD7', canonicalName:'CD7', status:'Loss', palette:'purple', cellularLocation:'surface', visualFamily:'forked-receptor', visualVariant:'hooked', resultState:'lost', orientation:-90, x:19, y:58, labelX:11, labelY:54,
  ...
  { id:'ki67', name:'Ki-67', canonicalName:'Ki-67', status:'Discussed', palette:'green', cellularLocation:'nucleus', visualFamily:'proliferation-pattern', resultState:'mentioned', x:54, y:51, labelX:86, labelY:80,
...
export const markerStudyMarkers: Marker[] = [
  ...
  { id:'study-cd7', name:'CD7', canonicalName:'CD7', status:'Illustrated receptor', palette:'purple', cellularLocation:'surface', visualFamily:'forked-receptor', visualVariant:'hooked', resultState:'present', exampleOnly:true,
    ...
    quote:'A surface receptor illustration; no patient result is represented.' },
  { id:'study-bcl2', name:'BCL2', canonicalName:'BCL2', status:'Illustrated location', palette:'gold', cellularLocation:'cytoplasm', visualFamily:'cytoplasmic-protein', resultState:'present', exampleOnly:true,
  ...
  { id:'study-p53', name:'p53', canonicalName:'p53', status:'Illustrated location', palette:'cyan', cellularLocation:'nucleus', visualFamily:'nuclear-protein', resultState:'present', exampleOnly:true,
