...
export const sampleMarkers: Marker[] = [
  ...
  { id:'cd30', name:'CD30', canonicalName:'CD30', status:'Present', palette:'coral', cellularLocation:'membrane', visualFamily:'branched-receptor', visualVariant:'three-tip', resultState:'present', size:1.2, orientation:16, x:71, y:25, labelX:83, labelY:16,
  ...
  { id:'cd7', name:'CD7', canonicalName:'CD7', status:'Loss', palette:'purple', cellularLocation:'membrane', visualFamily:'forked-receptor', visualVariant:'hooked', resultState:'lost', orientation:-90, x:19, y:58, labelX:11, labelY:54,
...
export const markerStudyMarkers: Marker[] = [
  ...
  { id:'study-cd7', name:'CD7', canonicalName:'CD7', status:'Illustrated receptor', palette:'purple', cellularLocation:'membrane', visualFamily:'forked-receptor', visualVariant:'hooked', resultState:'present', exampleOnly:true,
